...
<script>
  import {addItemObj, addObj, delItemObj, delObj, fetchItemList, fetchList, putItemObj, putObj} from '@/api/system/dict'
  import {tableDictItemOption, tableOption} from '@/const/crud/system/dict'
