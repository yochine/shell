...
public class MybatisPlusCodeGenerator {
    ...
    private static String url="jdbc:mysql://127.0.0.1:3306/shell?characterEncoding=utf8&useSSL=false";
    private static String username="root";
    private static String password="root@123456";
    private static String tablePrefix="gen_";
    private static String basePackage="me.zrxjava.generator";
...
//        String projectPath = "D:\\FeedFlow\\";
        ...
        pc.setEntity(basePackage+".entity");
        focList.add(new FileOutConfig(entityPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/" +   basePackage.replaceAll("\\.","/")  +"/entity"
                        + "/" + tableInfo.getEntityName() + StringPool.DOT_JAVA;
            }
        });
        //mapper
        String mapperPath = "/templates/mapper.java.vm";
        pc.setMapper(basePackage+".mapper");
        focList.add(new FileOutConfig(mapperPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/" +   basePackage.replaceAll("\\.","/")  +"/mapper"
        ...
        focList.add(new FileOutConfig(servicePath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/" +   basePackage.replaceAll("\\.","/")  +"/service"
        ...
        focList.add(new FileOutConfig(serviceImplPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/" +   basePackage.replaceAll("\\.","/")  +"/service/impl"
        ...
        focList.add(new FileOutConfig(controllerPath) {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/java/" +   basePackage.replaceAll("\\.","/")  +"/controller"
