...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        if (Objects.nonNull(user)){
            // 数据权限
            Map<Integer,Set<Long>> deptIds = authorityService.getDeptIds(user.getUserId(),user.getDeptId());
            // 操作权限
            Set<GrantedAuthority> grantedAuthorities = authorityService.getGrantedAuthorities(user.getUserId(),user.getIsAdmin());
